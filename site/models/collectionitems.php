 ...
 */
class CollectionviewsModelCollectionitems extends JModelList
{
    ...
    protected function getListQuery()
    {
        ...
        $query->from('`#__collectionviews_collectionitem` AS a');
        ...
        foreach($items as $item){
			...
			if ( isset($item->catid) ) {
				...
				// Get the title of that particular template
					$title = CollectionviewsFrontendHelper::getCategoryNameByCategoryId($item->catid);
