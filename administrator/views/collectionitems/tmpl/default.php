...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_collectionviews&task=collectionitems.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'collectionitemList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
...
<?php endif;?>
		...
		<table class="table table-striped" id="collectionitemList">
			...
			<?php foreach ($this->items as $i => $item) :
                ...
                <?php if (isset($this->items[0]->state)): ?>
					<td class="center">
						<?php echo JHtml::_('jgrid.published', $item->state, $i, 'collectionitems.', $canChange, 'cb'); ?>
					</td>
                <?php endif; ?>
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_collectionviews&task=collectionitem.edit&id='.(int) $item->id); ?>">
				...
				<td>
					...
					<?php
						if (!empty($item->file)):
							$uploadPath = 'components' . DIRECTORY_SEPARATOR . 'com_collectionviews' . DIRECTORY_SEPARATOR . 'uploaded-files' .DIRECTORY_SEPARATOR . $item->file;
